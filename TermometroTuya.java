...
public class TermometroTuya extends Termometro{
    ...
    TermometroTuya(double ultimaTemperaturaLida) {
    ...
    public double ler_dado() {
        ...
        if (UltimaTemperaturaLida == 0.0) {
            ...
            Random random = new Random();
            double min = UltimaTemperaturaLida - 1;
            double max = UltimaTemperaturaLida + 1;
            double randomDouble; // Gera uma temperatura entre UltimaTemperaturaLida - 1 e UltimaTemperaturaLida + 1
            randomDouble = min + (max - min) * random.nextDouble();
            UltimaTemperaturaLida = randomDouble;
            return randomDouble;
        }
